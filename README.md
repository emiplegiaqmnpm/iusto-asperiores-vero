![npm](https://img.shields.io/npm/v/@emiplegiaqmnpm/iusto-asperiores-vero.svg)
![GitHub](https://img.shields.io/github/license/onubo/@emiplegiaqmnpm/iusto-asperiores-vero.svg)
[![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/onubo/@emiplegiaqmnpm/iusto-asperiores-vero/issues)

# @emiplegiaqmnpm/iusto-asperiores-vero
...
![console log demo](https://raw.githubusercontent.com/onubo/@emiplegiaqmnpm/iusto-asperiores-vero/master/demo/demo-@emiplegiaqmnpm/iusto-asperiores-vero.png)
...
```sh
npm install --save @emiplegiaqmnpm/iusto-asperiores-vero
```

OR

```sh
yarn add @emiplegiaqmnpm/iusto-asperiores-vero
```

OR

```sh
expo install @emiplegiaqmnpm/iusto-asperiores-vero
```

## Quick Start

```javascript
import { logger } from "@emiplegiaqmnpm/iusto-asperiores-vero";
...
```javascript
import { logger, consoleTransport } from "@emiplegiaqmnpm/iusto-asperiores-vero";
...
```javascript
import { logger, transportFunctionType } from "@emiplegiaqmnpm/iusto-asperiores-vero";
...
```javascript
import { logger, fileAsyncTransport } from "@emiplegiaqmnpm/iusto-asperiores-vero";
...
@emiplegiaqmnpm/iusto-asperiores-vero includes some preset transports. You can import the one of your choice:
`import { logger, <transportName> } from '@emiplegiaqmnpm/iusto-asperiores-vero';`

#### Example

```javascript
import { logger, mapConsoleTransport } from "@emiplegiaqmnpm/iusto-asperiores-vero";
...
```javascript
import { logger, sentryTransport } from "@emiplegiaqmnpm/iusto-asperiores-vero";
...
All calls to `console.*` will then be handled by your @emiplegiaqmnpm/iusto-asperiores-vero logger and then you can manage their visibility via severity, or change their transports.
...
// all of the following console calls will use your @emiplegiaqmnpm/iusto-asperiores-vero logger
...
import {
  ...
  consoleTransport,
  fileAsyncTransport,
} from "@emiplegiaqmnpm/iusto-asperiores-vero";
import RNFS from "react-native-fs";
